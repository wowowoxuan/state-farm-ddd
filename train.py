...
net = VGG16(n_classes = 10, use_pretrained = True)
# net = tinyNet()
# net.load_state_dict(torch.load('/home/weiheng/workspace/Deepinsight/syntheticdata_exp/model_ddd.pth'))
...
optimizer = torch.optim.Adam(net.parameters(), lr=1e-4)#0.001 1e-3
...
trainset = train_val_set(root = '/media/weiheng/Elements/Data/state-farm-distracted-driver-detection/imgs/train_all', 
subject_img_csv_path = '/media/weiheng/Elements/Data/state-farm-distracted-driver-detection/driver_imgs_list.csv',
is_train = True,
val_subject = val_subject)
testset = train_val_set(root = '/media/weiheng/Elements/Data/state-farm-distracted-driver-detection/imgs/train_all', 
subject_img_csv_path = '/media/weiheng/Elements/Data/state-farm-distracted-driver-detection/driver_imgs_list.csv',
is_train = False,
val_subject = val_subject)
...
for epoch in range(200):
    ...
    if best_acc < acc or best_acc == acc:
        print('save model..................................................')
        best_acc = acc
        torch.save(net.state_dict(), './AlexNet_leave_subject.pth')
    print(best_acc)